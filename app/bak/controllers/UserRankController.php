...
class userRankController extends \BaseController {
	...
	public function delete()
	{
		...
		if (count(Input::get('ids')) > 1) {
			return Redirect::route('userRank.index')->with('message', 'UserRanks deleted.');
		}
		else {
	...
	public function disable()
	{
		...
		if (count(Input::get('ids')) > 1) {
			return Redirect::route('userRank.index')->with('message', 'UserRanks disabled.');
		}
		else {
	...
	public function enable()
	{
		...
		if (count(Input::get('ids')) > 1) {
			return Redirect::route('userRank.index')->with('message', 'UserRanks enabled.');
		}
		else {
