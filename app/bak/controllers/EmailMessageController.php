...
class emailMessageController extends \BaseController {
	...
	public function delete()
	{
		...
		if (count(Input::get('ids')) > 1) {
			return Redirect::route('cart.index')->with('message', 'EmailMessages deleted.');
		}
		else {
	...
	public function disable()
	{
		...
		if (count(Input::get('ids')) > 1) {
			return Redirect::route('cart.index')->with('message', 'EmailMessages disabled.');
		}
		else {
	...
	public function enable()
	{
		...
		if (count(Input::get('ids')) > 1) {
			return Redirect::route('cart.index')->with('message', 'EmailMessages enabled.');
		}
		else {
