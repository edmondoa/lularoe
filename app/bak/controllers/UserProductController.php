...
class userProductController extends \BaseController {
	...
	public function delete()
	{
		...
		if (count(Input::get('ids')) > 1) {
			return Redirect::route('userProduct.index')->with('message', 'UserProducts deleted.');
		}
		else {
	...
	public function disable()
	{
		...
		if (count(Input::get('ids')) > 1) {
			return Redirect::route('userProduct.index')->with('message', 'UserProducts disabled.');
		}
		else {
	...
	public function enable()
	{
		...
		if (count(Input::get('ids')) > 1) {
			return Redirect::route('userProduct.index')->with('message', 'UserProducts enabled.');
		}
		else {
