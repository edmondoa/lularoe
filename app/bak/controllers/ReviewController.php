...
class reviewController extends \BaseController {
	...
	public function delete()
	{
		...
		if (count(Input::get('ids')) > 1) {
			return Redirect::route('review.index')->with('message', 'Reviews deleted.');
		}
		else {
	...
	public function disable()
	{
		...
		if (count(Input::get('ids')) > 1) {
			return Redirect::route('review.index')->with('message', 'Reviews disabled.');
		}
		else {
	...
	public function enable()
	{
		...
		if (count(Input::get('ids')) > 1) {
			return Redirect::route('review.index')->with('message', 'Reviews enabled.');
		}
		else {
