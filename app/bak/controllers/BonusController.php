...
class bonusController extends \BaseController {
	...
	public function delete()
	{
		...
		if (count(Input::get('ids')) > 1) {
			return Redirect::route('bonus.index')->with('message', 'Bonuses deleted.');
		}
		else {
	...
	public function disable()
	{
		...
		if (count(Input::get('ids')) > 1) {
			return Redirect::route('bonus.index')->with('message', 'Bonuses disabled.');
		}
		else {
	...
	public function enable()
	{
		...
		if (count(Input::get('ids')) > 1) {
			return Redirect::route('bonus.index')->with('message', 'Bonuses enabled.');
		}
		else {
