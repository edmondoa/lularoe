...
@section('content')
<div ng-app="app">
    {{ Form::open(array('url' => 'image/disable', 'method' => 'POST')) }}
	    <div ng-controller="ImageController" class="my-controller">
	        <div class="row">
	            <div class="col col-md-8">
	                <h1 class="no-top">All Images</h1>
	            </div>
	        ...
	        <div class="row">
	            <div class="col col-md-12">
	                <div class="pull-left">
	                    <a class="btn btn-success pull-left margin-right-1" title="New" href="{{ url('image/create') }}"><i class="fa fa-plus"></i></a>
	                    <div class="pull-left">
	                        <div class="input-group">
	                            <select class="form-control selectpicker actions">
	                                <option value="image/disable" selected>Disable</option>
	                                <option value="image/enable">Enable</option>
	                                <option value="image/delete">Delete</option>
	                            </select>
	        ...
	        <div class="row">
	            <div class="col col-md-12">
	                <table class="table">
	                    ...
	                    <tbody>
	                        <tr dir-paginate-start="image in images | filter:search | orderBy:orderByField:reverseSort | itemsPerPage: pageSize" current-page="currentPage">
