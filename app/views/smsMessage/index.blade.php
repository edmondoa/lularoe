...
@section('content')
<div ng-app="app">
    {{ Form::open(array('url' => 'smsMessage/disable', 'method' => 'POST')) }}
	    <div ng-controller="SmsMessageController" class="my-controller">
	        <div class="row">
	            <div class="col col-md-8">
	                <h1 class="no-top">All SmsMessages</h1>
	            </div>
	        ...
	        <div class="row">
	            <div class="col col-md-12">
	                <div class="pull-left">
	                    <a class="btn btn-success pull-left margin-right-1" title="New" href="{{ url('smsMessage/create') }}"><i class="fa fa-plus"></i></a>
	                    <div class="pull-left">
	                        <div class="input-group">
	                            <select class="form-control selectpicker actions">
	                                <option value="smsMessage/disable" selected>Disable</option>
	                                <option value="smsMessage/enable">Enable</option>
	                                <option value="smsMessage/delete">Delete</option>
	                            </select>
	                ...
	                <table class="table">
	                    <thead>
	                        <tr>
                            	...
                            	<th ng-click="orderByField='sender_id'; reverseSort = !reverseSort">Sender Id
                            	...
                            	<th ng-click="orderByField='recipient_id'; reverseSort = !reverseSort">Recipient Id
                            		<span class='link' href='#'>
	                    ...
	                    <tbody>
	                        <tr dir-paginate-start="smsMessage in smsMessages | filter:search | orderBy:orderByField:reverseSort | itemsPerPage: pageSize" current-page="currentPage">
...
<script>
	...
	function SmsMessageController($scope, $http) {
	
		$http.get('/api/all-smsMessages').success(function(smsMessages) {
