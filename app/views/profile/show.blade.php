...
<div class="row">
	<div class="col col-md-12">
	    ...
	    <div class="btn-group">
		    <a class="btn btn-default" href="{{ url('profile/'.$profile->id .'/edit') }}" title="Edit"><i class="fa fa-pencil"></i></a>
		    @if ($profile->disabled == 0)
			    {{ Form::open(array('url' => 'profile/disable', 'method' => 'DISABLE')) }}
			    ...
			    {{ Form::close() }}
			@else
			    {{ Form::open(array('url' => 'profile/enable', 'method' => 'ENABLE')) }}
			    	<input type="hidden" name="ids[]" value="{{ $profile->id }}">
