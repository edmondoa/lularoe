...
<div ng-app="app" class="index">
    {{ Form::open(array('url' => 'userProducts/disable', 'method' => 'POST')) }}
	    <div ng-controller="UserProductController" class="my-controller">
	    	<div class="page-actions">
		        <div class="row">
		            <div class="col-md-12">
		                <h1 class="no-top pull-left no-pull-xs">All UserProducts</h1>
		        ...
		        <div class="row">
		            <div class="col-md-6 col-sm-6 col-xs-12 page-actions-left">
		                <div class="pull-left">
		                    <a class="btn btn-primary pull-left margin-right-1" title="New" href="{{ url('userProducts/create') }}"><i class="fa fa-plus"></i></a>
		                    <div class="pull-left">
		                        <div class="input-group">
		                            <select class="form-control selectpicker actions">
		                                <option value="userProducts/disable" selected>Disable</option>
		                                <option value="userProducts/enable">Enable</option>
		                                <option value="userProducts/delete">Delete</option>
		                            </select>
	        ...
	        <div class="row">
	            <div class="col col-md-12">
	                <table class="table">
	                    ...
	                    <tbody>
	                        <tr ng-class="{highlight: address.new == 1}" dir-paginate-start="userProduct in userProducts | filter:search | orderBy: '-updated_at' | orderBy:orderByField:reverseSort | itemsPerPage: pageSize" current-page="currentPage" total-items="countItems">
					            ...
					            <td>
					            	<a href="/userProducts/@include('_helpers.userProduct_id')"><span ng-bind="userProduct.updated_at"></span></a>
					            </td>
	                        </tr>
...
<script>
    angular.extend(ControlPad, (function(){                
                return {
                    userProductCtrl : {
                        path : '/api/all-userProducts'
                    }
                };
            }()));    
</script>
{{ HTML::script('js/controllers/userProductController.js') }}
@stop