...
<div class="container-wrap">
	...
	<div id="fws_546a4816763c0" class="wpb_row vc_row-fluid full-width-section standard_section    "  style="padding-top: 0px; padding-bottom: 0px; "><div class="col span_12 light center">
	<div  class="vc_span12 wpb_column column_container col no-extra-padding"  data-hover-bg="" data-animation="" data-delay="0">
		<div class="wpb_wrapper">
			<div style="height: 650px" class="parallax_slider_outer "><div style="height: 650px" data-transition="fade" data-flexible-height="" data-fullscreen="true" data-autorotate="" data-parallax="true" data-full-width="true" class="nectar-slider-wrap " id="ns-id-546a4816767a8">
				    ...
				    <div class="swiper-wrapper"><div class="swiper-slide" style="background-image: url(/wp-content/uploads/2014/09/DPExample.jpg);" data-bg-alignment="center" data-color-scheme="dark" data-x-pos="centered" data-y-pos="middle"> 
								<div class="container">
									<div class="content"><h2>Next Website Update <br> 12.1.2014</h2><p class="transparent-bg" ><span>Pre-launch Starts in:</span></p><div class="buttons"><div class="button solid_color">
												 		 <a class="extra-color-1" href="//my.sociallymobile.com/join">JOIN NOW</a>
												 	 </div></div></div>
...
<script type='text/javascript'>
/* <![CDATA[ */
var nectarLove = {"ajaxurl":"http:\/\/sociallymobile-wordpress\/wp-admin\/admin-ajax.php","postID":"3063","rooturl":"http:\/\/sociallymobile-wordpress","pluginPages":[],"disqusComments":"false"};
/* ]]> */
</script>
