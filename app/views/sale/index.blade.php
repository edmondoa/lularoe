...
<div ng-app="app" class="index">
    {{ Form::open(array('url' => 'sales/disable', 'method' => 'POST')) }}
	    <div ng-controller="SaleController" class="my-controller">
	    	<div class="page-actions">
		        <div class="row">
		            <div class="col-md-12">
		                <h1 class="no-top pull-left no-pull-xs">All Sales</h1>
		        ...
		        <div class="row">
		            <div class="col-md-6 col-sm-6 col-xs-12 page-actions-left">
		                <div class="pull-left">
		                    <a class="btn btn-primary pull-left margin-right-1" title="New" href="{{ url('sales/create') }}"><i class="fa fa-plus"></i></a>
		                    <div class="pull-left">
		                        <div class="input-group">
		                            <select class="form-control selectpicker actions">
		                                <option value="sales/disable" selected>Disable</option>
		                                <option value="sales/enable">Enable</option>
		                                <option value="sales/delete">Delete</option>
		                            </select>
	        ...
	        <div class="row">
	            <div class="col col-md-12">
	                <table class="table">
	                    ...
	                    <tbody>
	                        <tr ng-class="{highlight: address.new == 1}" dir-paginate-start="sale in sales | filter:search | orderBy: '-updated_at' | orderBy:orderByField:reverseSort | itemsPerPage: pageSize" current-page="currentPage" total-items="countItems">
	                            <td ng-click="checkbox()">
	                            	<input class="bulk-check" type="checkbox" name="ids[]" value="@include('_helpers.sale_id')">
	                            </td>
								
					            <td>
					                <a href="/sales/@include('_helpers.sale_id')"><span ng-bind="sale.product_id"></span></a>
					            </td>
					            
					            <td>
					                <a href="/sales/@include('_helpers.sale_id')"><span ng-bind="sale.user_id"></span></a>
					            </td>
					            
					            <td>
					                <a href="/sales/@include('_helpers.sale_id')"><span ng-bind="sale.sponsor_id"></span></a>
					            </td>
					            
					            <td>
					                <a href="/sales/@include('_helpers.sale_id')"><span ng-bind="sale.quantity"></span></a>
					            </td>
					            
					            <td>
					                <a href="/sales/@include('_helpers.sale_id')"><span ng-bind="sale.disabled"></span></a>
					            </td>
					            
					            <td>
					            	<a href="/sales/@include('_helpers.sale_id')"><span ng-bind="sale.updated_at"></span></a>
					            </td>
	                        </tr>
...
{{ HTML::script('js/controllers/saleController.js') }}
@stop