	...
	<div class="row page-actions">
	    ...
	    <div class="btn-group">
			...
			@else
			    ...
			    {{ Form::close() }}
			@endif
		    {{ Form::open(array('url' => 'emailMessages/' . $emailMessage->id, 'method' => 'DELETE', 'onsubmit' => 'return confirm("Are you sure you want to delete this record? This cannot be undone.");')) }}
