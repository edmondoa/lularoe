...
@section('content')
<div ng-app="app">
    {{ Form::open(array('url' => 'emailMessage/disable', 'method' => 'POST')) }}
	    <div ng-controller="EmailMessageController" class="my-controller">
	        <div class="row">
	            <div class="col col-md-8">
	                <h1 class="no-top">All EmailMessages</h1>
	            </div>
	        ...
	        <div class="row">
	            <div class="col col-md-12">
	                <div class="pull-left">
	                    <a class="btn btn-success pull-left margin-right-1" title="New" href="{{ url('emailMessage/create') }}"><i class="fa fa-plus"></i></a>
	                    <div class="pull-left">
	                        <div class="input-group">
	                            <select class="form-control selectpicker actions">
	                                <option value="emailMessage/disable" selected>Disable</option>
	                                <option value="emailMessage/enable">Enable</option>
	                                <option value="emailMessage/delete">Delete</option>
	                            </select>
	                ...
	                <table class="table">
	                    <thead>
	                        <tr>
                            	...
                            	<th ng-click="orderByField='subject'; reverseSort = !reverseSort">Subject
                            		<span class='link' href='#'>
	                    ...
	                    <tbody>
	                        <tr dir-paginate-start="emailMessage in emailMessages | filter:search | orderBy:orderByField:reverseSort | itemsPerPage: pageSize" current-page="currentPage">
