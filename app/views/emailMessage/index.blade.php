	        ...
	        <div class="row">
	            <div class="col col-md-12">
	                <table class="table">
	                    ...
	                    <tbody>
	                        <tr ng-class="{highlight: address.new == 1}" dir-paginate-start="emailMessage in emailMessages | filter:search | orderBy: '-updated_at' | orderBy:orderByField:reverseSort | itemsPerPage: pageSize" current-page="currentPage" total-items="countItems">
...
<script>
    angular.extend(ControlPad, (function(){                
                return {
                    emailMessageCtrl : {
                        path : '/api/all-emailMessages'
                    }
                };
            }()));    
</script>
{{ HTML::script('js/controllers/emailMessageController.js') }}
@stop