	...
	<div ng-app ng-controller="PartyInviteController">
		...
		<div class="row">
			<div class="col col-md-6">
				{{ Form::open( array('route' => 'blast-party-invites')) }}
							...
							<div class="panel-body">
								<table class="table">
									...
									<tr>
										...
										<td>
											<p>Dear [First Name],</p>
											<p>I'd like to invite you to my {{ Config::get('site.company_name') }} party on <span ng-bind="party.date_start | date:'MMM d'"></span>.</p>
