...
@section('content')
<div ng-app="app">
    {{ Form::open(array('url' => 'cart/disable', 'method' => 'POST')) }}
	    <div ng-controller="CartController" class="my-controller">
	        <div class="row">
	            <div class="col col-md-8">
	                <h1 class="no-top">All Carts</h1>
	            </div>
	        ...
	        <div class="row">
	            <div class="col col-md-12">
	                <div class="pull-left">
	                    <a class="btn btn-success pull-left margin-right-1" title="New" href="{{ url('cart/create') }}"><i class="fa fa-plus"></i></a>
	                    <div class="pull-left">
	                        <div class="input-group">
	                            <select class="form-control selectpicker actions">
	                                <option value="cart/disable" selected>Disable</option>
	                                <option value="cart/enable">Enable</option>
	                                <option value="cart/delete">Delete</option>
	                            </select>
	        ...
	        <div class="row">
	            <div class="col col-md-12">
	                <table class="table">
	                    ...
	                    <tbody>
	                        <tr dir-paginate-start="cart in carts | filter:search | orderBy:orderByField:reverseSort | itemsPerPage: pageSize" current-page="currentPage">
