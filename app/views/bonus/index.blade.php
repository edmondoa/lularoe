...
@section('content')
<div ng-app="app">
    {{ Form::open(array('url' => 'bonus/disable', 'method' => 'POST')) }}
	    <div ng-controller="BonusController" class="my-controller">
	        <div class="row">
	            <div class="col col-md-8">
	                <h1 class="no-top">All Bonuses</h1>
	            </div>
	        ...
	        <div class="row">
	            <div class="col col-md-12">
	                <div class="pull-left">
	                    <a class="btn btn-success pull-left margin-right-1" title="New" href="{{ url('bonus/create') }}"><i class="fa fa-plus"></i></a>
	                    <div class="pull-left">
	                        <div class="input-group">
	                            <select class="form-control selectpicker actions">
	                                <option value="bonus/disable" selected>Disable</option>
	                                <option value="bonus/enable">Enable</option>
	                                <option value="bonus/delete">Delete</option>
	                            </select>
	                ...
	                <table class="table">
	                    <thead>
	                        <tr>
                            	...
                            	<th ng-click="orderByField='eight_in_eight'; reverseSort = !reverseSort">Eight In Eight
                            		<span class='link' href='#'>
                            	...
                            	<th ng-click="orderByField='twelve_in_twelve'; reverseSort = !reverseSort">Twelve In Twelve
                            		<span class='link' href='#'>
	                    ...
	                    <tbody>
	                        <tr dir-paginate-start="bonus in bonuses | filter:search | orderBy:orderByField:reverseSort | itemsPerPage: pageSize" current-page="currentPage">
