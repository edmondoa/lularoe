	        ...
	        <div class="row">
	            <div class="col col-md-12">
	                <table class="table">
	                    ...
	                    <tbody>
	                        <tr ng-class="{highlight: address.new == 1}" dir-paginate-start="review in reviews | filter:search | orderBy: '-updated_at' | orderBy:orderByField:reverseSort | itemsPerPage: pageSize" current-page="currentPage" total-items="countItems">
...
<script>
    angular.extend(ControlPad, (function(){                
                return {
                    reviewCtrl : {
                        path : '/api/all-reviews'
                    }
                };
            }()));    
</script>
{{ HTML::script('js/controllers/reviewController.js') }}
@stop