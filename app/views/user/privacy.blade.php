	...
	<div class="row">
		<div class="col col-md-6">
			{{ Form::open(array('action' => array('UserController@updatePrivacy', $user->id), 'method' => 'POST')) }}
				<div class="row">
					<div class="col col-md-6">
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<p>Which information you would like to to share with ISM's who have you in their downline?*</p>
					...
					<div class="col col-md-6">
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<p>Whick kinds of communication would you like to receive from ISM's who have you in their downline?</p>
				...
				<br>
				<br>
				<p><small>* These preferences only apply to ISM's below the rank of Diamond. ISM's of the Diamond rank or higher will be able to view all of the above information regardless. For more information about how {{ Config::get('site.company_name') }} collects and displays your information, see the <a target="_blank" href="/privacy-policy">Privacy Policy.</a></small></p>
		    {{Form::close()}}
		</div>
	</div>
</div>
