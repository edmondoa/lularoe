...
@section('content')
<div ng-app="app">
    {{ Form::open(array('url' => 'role/disable', 'method' => 'POST')) }}
	    <div ng-controller="RoleController" class="my-controller">
	        ...
	        <div class="row">
	            <div class="col col-md-12">
	                <div class="pull-left">
	                    <a class="btn btn-success pull-left margin-right-1" title="New" href="{{ url('role/create') }}"><i class="fa fa-plus"></i></a>
	                    <div class="pull-left">
	                        <div class="input-group">
	                            <select class="form-control selectpicker actions">
	                                <option value="role/disable" selected>Disable</option>
	                                <option value="role/enable">Enable</option>
	                                <option value="role/delete">Delete</option>
	                            </select>
	        ...
	        <div class="row">
	            <div class="col col-md-12">
	                <table class="table">
	                    ...
	                    <tbody>
	                        <tr dir-paginate-start="role in roles | filter:search | orderBy:orderByField:reverseSort | itemsPerPage: pageSize" current-page="currentPage">
